                ...
                <tbody class="last-page">
                  ...
                  <tr>
                    ...
                    <td colspan="3" style="border-left: ; text-align: left;">
                      ...
                      @if($totallbp > 0) Other Payable (LBP) <br> @endif
                      @if($totalcauyan > 0) Other Payable (Cauyan) <br> @endif
                      @if($totalprojects > 0) Other Payable (Projects) <br> @endif
                      @if($totalnsca_mpc > 0) Other Payable (NSCA MPC) <br> @endif
                      @if($totalmed_deduction > 0) Other Payable (Medical Deduction) <br> @endif
                      @if($totalgrad_guarantor > 0) Other Payable (Grad. Shcl. / Guarantor) <br> @endif
                      @if($totalcfi > 0) Other Payable (CFI) <br> @endif
                      @if($totalcsb > 0) Other Payable (CSB) <br> @endif
                      @if($totalfasfeed > 0) Other Payable (FASFEED) <br> @endif
                      @if($totaldis_unliquidated > 0) Other Payable (Dis. ANCE / UNLIQ.) <br> @endif
