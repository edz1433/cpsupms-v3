<script>
    ...
    function stat(val){
        if(val == "1"){
            ...
            insrate.value = "";
            var jtype = document.getElementById("jo-type");
            jtype.value = "";
        }
        ...
        if(val == 4){
            ...
            $("#jo-type").show();
            $("#jo-type-ed").show();
            var jotype = document.getElementById("jo-type");
                if(jotype == 1){
    ...
    function stat1(val){
        if(val == "1"){
            ...
            var insrate1 = document.getElementById("insrate1");
            insrate1.placeholder = "Monthly Rate";
            var jtype = document.getElementById("jo-type-ed");
            jtype.value = "";
        }
        ...
        if(val == 3){
            ...
            $("#jo-type-ed").hide();
            var insrate1 = document.getElementById("insrate1");
            insrate1.placeholder = "Rate / hour";
            var jtype = document.getElementById("jo-type-ed");
            jtype.value = "";
        }
        ...
        $(document).on('click', '.employee_edit', function(e){ 
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $("#jo-type-s").val(response.emp.jo_type).change();
