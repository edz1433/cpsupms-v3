                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="sg_step" name="sg_step" oninput="this.value = this.value.restOfStr()" placeholder="SG-Step" class="form-control">
                                    </div>
                                ...
                                <div class="col-md-6" id="jo-type">
                                    <label for="exampleInputName" id="type-title">Type</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                        ...
                                        <select class="form-control select2bs4" onchange="joptype(this.value)" style="width: 88%;" name="jo_type" required>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="mname" name="MiddleName" oninput="this.value = this.value.toUpperCase()" placeholder="Enter Middle Name" class="form-control">
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="sg_step1" name="sg_step" oninput="this.value = this.value.restOfStr()" placeholder="SG-Step" class="form-control">
                                    </div>
                                    <span id="error" style="color: #FF0000; font-size: 10pt;" class="form-text text-left Position_error1"></span>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6" id="jo-type-ed">
                                    <label for="exampleInputName" id="type-title">Type</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                        ...
                                        <select class="form-control select2bs4" onchange="joptype(this.value)" id="jo-type-s" style="width: 88%;" name="jo_type" required>
                                            <option value=""></option>
                                            <option value="1">Monthly Bases</option>
                                            <option value="2">Daily Bases</option>
                                        </select>
                                    </div>
                                    <span id="error" style="color: #FF0000; font-size: 10pt;" class="form-text text-left jo_type_error"></span>
                                </div>
    
                                <div class="col-md-6" id="srate1">
                                    <label for="exampleInputName rate-title1"  id="rate-title1">Salary Rate</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i class="fas fa-coins"></i>
