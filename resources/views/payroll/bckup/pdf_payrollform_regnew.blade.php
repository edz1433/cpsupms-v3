                  ...
                  @if ($data->offid === $groupValue)
                    ...
                    <tr>
                      ...
                      <td>{{ number_format($data->add_less_abs1, 2) }}</td>
                        @php $saltype == 1 || $saltype == 3 ? $totalrowEarnperiod += round($data->sumRef, 2) : '0.00' @endphp
                        <td >{{{ $saltype == 1 || $saltype == 3 ? number_format($rowEarn + ($data->sumRef - $absences1), 2) : '0.00' }}}</td>
                        @if($column1sumded > 0)
                      ...
                      <td >{{ $saltype == 1 || $saltype == 3 ? number_format($rowEarn + ($data->sumRef - $absences1) - ($data->sumDed), 2) : '0.00' }}</td>
                      <td></td>
                      <td >{{ $saltype == 1 || $saltype == 3 ? number_format($rowEarn + ($data->sumRef - $absences1) - ($data->sumDed), 2) : '0.00' }}</td>
                      </tr>
                      @endif
