                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($pfiles as $p)
                                            ...
                                            <tr id="tr-data" class="tr-data tr-{{ $p->pid }}">
                                                ...
                                                <td class="firstHalf">{{ $p->status != 3 && $saltype == 1 ? number_format($sechalearn1, 2) : '0.00' }}</td>
                                                <td class="secondtHalf{{ $p->status == 3 ? '-Incomplete' : '' }}">{{ number_format($sechalearn + $p->sumRef - $p->sumDed, 2);}}</td>
                                                {{-- <td>
                                                    <div class="btn-group">
