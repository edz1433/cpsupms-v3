    ...
    public function showPdf($payrollID, $statID, $pid, $offid)
    {
        ...
        $datas = DB::table('payroll_files')
            ...
            if($statID == 1){
                ...
                $currRoute == "transmittal" ? $viewTemplate = 'payroll.pdf_transmittal' : $viewTemplate = $pid == 1 ? 'payroll.pdf_payrollform_reg' : 'payroll.pdf_payrollform_regnew';
                ...
                $viewTemplate = ($statID == 4) ? $viewTemplate = $payroll->jo_type == 1 ? 'payroll.pdf_payrollform_jo' : 'payroll.pdf_payrollform_jo1' : (($statID == 3) ? 'payroll.pdf_payrollform_partime_jo' : 'payroll.pdf_payrollform_partime');
